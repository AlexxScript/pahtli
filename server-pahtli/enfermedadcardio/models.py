...
class Cardio(models.Model):
    ...
    azucar_sangre_ayuno = models.DecimalField(max_digits=10,decimal_places=2) #mg/dl 
    azucar_sangre_cat = models.IntegerField(default=0) #mg/dl si es mayor a 120 entonces es 1 Categorico
