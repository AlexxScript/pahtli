            ...
            <main className="">
                <aside className="ml-[-100%] fixed z-10 top-0 w-full flex flex-col h-screen border-r border-r-zinc-900 bg-[#202020] transition duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%]">
                    ...
                    <ul className="flex flex-col gap-4 my-10">
                        ...
                        <li>
                            <Link href="/dashboard" className="p-3 flex gap-2 w-full hover:bg-[#84D5C022] hover:text-[#84D5C0] transition-all duration-150">
                        ...
                        <li>
                            <Link href="/" className="p-3 flex gap-2 w-full hover:bg-[#84D5C022] hover:text-[#84D5C0] transition-all duration-150">
                ...
                <section className="my-8 ml-auto mb-6 lg:w-[75%] xl:w-[80%] 2xl:w-[85%]">
                    {children}
                </section>    
            </main>  
        </>
